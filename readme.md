...
```sh
npx install-peerdeps --yarn --dev -o eslint-config-upleveled
cp node_modules/eslint-config-upleveled/templates/.eslintrc.json ./
cp node_modules/eslint-config-upleveled/templates/tsconfig.json ./
```
